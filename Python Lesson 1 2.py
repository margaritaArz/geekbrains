...
'''
#нельзя в битовом типе представить слова, написанные не латиницей.
...
subproc_ping_1 = subprocess.Popen(web1, stdout=subprocess.PIPE)
subproc_ping_2 = subprocess.Popen(web2, stdout=subprocess.PIPE)
